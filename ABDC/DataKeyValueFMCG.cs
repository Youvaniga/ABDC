...
namespace ABDC
{
    public class DataKeyValueFMCG : INotifyPropertyChanged
    {
          
        #region fields
        private static List<DataKeyValueFMCG> _toList;
        private int _Id;
        ...
        public static List<DataKeyValueFMCG> toList
        {
            get
            {
                if (_toList == null)
                {
                    ...
                    {
                        _toList = db.DataKeyValues.Where(x => x.CompanyId == CompanyId).ToList().Select(x => new DataKeyValueFMCG() { DataKey = x.DataKey, DataValue = x.DataValue }).ToList();
                    }
                }
                return _toList;
            }
