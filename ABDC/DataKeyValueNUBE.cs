...
namespace ABDC
{
    public class DataKeyValueNUBE : INotifyPropertyChanged
    {


        #region fields
        private static List<DataKeyValueNUBE> _toList;
        private int _Id;
        ...
        public static List<DataKeyValueNUBE> toList
        {
            get
            {
                if (_toList == null)
                {
                    ...
                    {
                        _toList =  db.DataKeyValues.Where(x=> x.FundMasterId== CompanyId ).ToList().Select(x=> new DataKeyValueNUBE() { DataKey= x.DataKey,DataValue = x.DataValue }).ToList();
                    }
                }
                return _toList;
            }
